...
import net.awired.ajsl.cli.argument.args.CliDefaultHelperArgument;
import net.awired.ajsl.cli.argument.args.CliNoParamArgument;
import net.awired.ajsl.cli.argument.args.CliOneParamArgument;
import net.awired.ajsl.cli.argument.args.CliTwoParamArgument;
import net.awired.ajsl.cli.argument.implementation.ArgumentTestManager.Scenarios;
import net.awired.ajsl.cli.argument.implementation.ArgumentTestManager.Transactions;
import net.awired.ajsl.cli.param.CliParamEnum;
import net.awired.ajsl.cli.param.CliParamInetAddress;
import net.awired.ajsl.cli.param.CliParamInt;

public class ArgumentTest2Manager extends CliArgumentManager {
